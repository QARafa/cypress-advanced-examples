...
describe('Hacker Stories', () => {
  ...
  context('Mocking the API', function () {
    context('Footer and list of stories', function () {
      beforeEach(() => {
  ...
  context('Search', () => {
    ...
    it('shows no story when none is returned', function () {
    ...
    it('types and submits the form directly', function () {
